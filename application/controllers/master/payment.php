...
class Payment extends CI_Controller {
	...
	{
		$datahead['title'] = "Methods of Payment";
		$datanav['activenav'] = "master";
		$dataside['activesidebar'] = "payment";
		$databread['breadcumb'] = '<li><a href="">Dashboard</a></li>';
		$databread['breadcumb'] .= '<li><i class="fa fa-angle-right"></i><a href="">Master</a></li>';
		$databread['breadcumb'] .= '<li><i class="fa fa-angle-right"></i><a href="">Methods of Payment</a></li>';
		...
		$this->load->view('master/payment.php');
